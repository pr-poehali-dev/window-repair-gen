...
const Submitted = () => {
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=107023144', 'ym');
      ym(107023144, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
    `;
    document.head.appendChild(script);

    const noscript = document.createElement('noscript');
    noscript.innerHTML = '<div><img src="https://mc.yandex.ru/watch/107023144" style="position:absolute; left:-9999px;" alt="" /></div>';
